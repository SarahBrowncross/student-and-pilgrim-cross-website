			...
			<Row pink>
				<SectionLeft width={'70'}>
					...
					<Text>
						...
						Pilgrim Cross believes in and is committed to the safety of all children, particularly those involved in the annual Easter pilgrimage to Walsingham. The pilgrimage will try to create a safe environment for all children and young people involved in the pilgrimage in the following ways:
					</Text>
					<BulletList>
					...
					<Text>Pilgrim Cross is very grateful for the hospitality shown by those who welcome us. This includes publicans, many of whom have become good friends of the pilgrimage over the years. The pilgrimage does not wish to see their livelihoods compromised by the activity of any pilgrims.<br /><br />
