...
export default function SCA() {
	return <PageBase title="family bursaries">
		<PageContainer>
			...
			<Row>
				<SectionLeft width={70}>
					<Text>
						...
						As a family booking on a family leg of Pilgrim Cross, you are asked to self-declare in one of the following 3 categories:<br /><br />
					</Text>
					<BulletList>
						<li>
