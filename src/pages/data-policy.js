		...
		<PageContainer>
			...
			<Row pink>
				<SectionLeft width={'70'}>
					<Text>The organisers, leaders and officers of the Pilgrim Cross pilgrimage - including the Student Cross Association (SCA) - recognise and treat as serious and important the privacy of all those who take part in the pilgrimage and communicate with us at any time.<br /><br />

						There are a number of ways that you may share personal information and data with Pilgrim Cross organisers and officers before, during and after taking part in the pilgrimage. In all of these interactions, you consent to the collection and use of your personal information in accordance with this policy.<br /><br />

						This policy covers centrally-managed and leg-specific activities of Pilgrim Cross and the SCA. National officers and leg leadership teams may only keep personal contact data of present and past participants of the pilgrimage who have opted in for that data to be kept.<br /><br />
						...
						The processing of personal data is regulated by current law including the General Data Protection Regulation (GDPR). Any requests by individuals for access to information held about them by Pilgrim Cross should be made in writing to us by <Link mailto='ZGF0YUBzdHVkZW50Y3Jvc3Mub3JnLnVr'>email.</Link></Text>

					<Subheading>How personal information is collected</Subheading>

					<Text>The remainder of this Policy describes the specific, main ways that you may share personal information with Pilgrim Cross. This list is not exhaustive and personal information may be gathered and used for other specific reasons as required.</Text>

					<Subheading>1. Booking and applications</Subheading>

					<Text>To facilitate bookings to join each annual Pilgrim Cross pilgrimage, organisers and leaders operate an online/digital booking system. We require applicants to apply by submitting information, including personal contact information, through that system. This personal data is required in order to facilitate your participation in the pilgrimage and ensure that we can send you the information necessary to take part.<br /><br />
					...
					<Text>The Student Cross Association (SCA) is a registered charity that exists to raise and disburse funds to needy pilgrims to enable them to take part in Pilgrim Cross.<br /><br />
					...
					<Text>The main Pilgrim Cross website does not currently require visitors to log in to access any information. As such no personal information is required to use the website. In common with most websites, our website may gather logs of activity including location and IP of the user’s computer.<br /><br />

						Pilgrim Cross currently uses a number of social media platforms, including Facebook and Twitter. Some of these outputs are managed by national officers, some by leg leaders (or other volunteers acting on their behalf). Users can choose to join or follow our social media groups or feeds, subject to the privacy and data policies of the relevant social media platform.<br /><br />

					</Text>

					<Subheading>5. Online meetings and streaming</Subheading>

					<Text>Some footage of Easter services in Walsingham may be privately live-streamed to registered, virtual pilgrims. Some readers and volunteers may choose to opt into the streaming, otherwise pilgrims will not be on camera. <br /><br />Pilgrim Cross and the SCA periodically host online meetings via third-party video conferencing tools. Some of these meetings are recorded for catch-up or publicity purposes. Examples of online meetings include organisational committees, general meetings, liturgies and other pilgrimage activities.<br /><br />
