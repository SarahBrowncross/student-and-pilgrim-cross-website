		...
		<PageContainer>
			...
			<Row>
				<SectionLeft width={70}>
					<Aside>
						<p>Student and Pilgrim Cross began in 1948 when Wilfred Maundcote-Carter organised a 'Cross Carrying Pilgrimage of Penance and Prayer'. 30 male Catholic students and chaplains took part, walking from London to Walsingham during Holy Week. They had such a great time that at the end of the week they turned to each other and said 'shall we do it again next year?'</p><br />
			...
			<Timeline>
				<TimelineItem pink src="/SX-firstyear.jpg" year="1948" text="Student and Pilgrim Cross is founded as Student Cross" />
				...
				<TimelineItem src="/SX-vintage-5.jpg" year="1972" text="Student and Pilgrim Cross starts to welcome pilgrims from across the Christian traditions" />
				...
				<TimelineItem src="/wensum-square.jpg" year="2012" text="With the founding of Wensum, Student and Pilgrim Cross now offers a bespoke pilgrimage experience for teenagers" />
				<TimelineItem pink src="/virtual-square.jpg" year="2020" text="Student and Pilgrim Cross goes virtual in response to the COVID-19 pandemic" />
				<TimelineItem imageBoarder={{ border: '1px solid grey' }} src="/logo.jpg" year="2022" text="We'll be back! Watch this space..." />
			</Timeline>
