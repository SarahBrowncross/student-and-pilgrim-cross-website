		...
		<PageContainer>
			...
			<Row>
				<SectionLeft width={70}>
					...
					<Link href='/SCA-Treasurers-Report-2021.pdf'>Treasurer's Report 2020</Link>
					<Link href='/SCA-Accounts-2020.pdf'>SCA Annual Accounts 2019</Link>
					...
					<Text>
						...
						Paul Fay (elected to 2026)<br />
						Una Moran (elected to 2026)<br />
					...
					<Text>
						The SCA Committee meets a minimum of twice per year. The first meeting is the SCA AGM. This is normally held at the same time and place as the Pilgrim Cross AGM (usually in the Pilgrim Bureau in Walsingham each Holy Saturday). The second meeting is held in Walsingham every Holy Saturday, usually after the Pilgrim Cross AGM. The third meeting is usually held in October. This third meeting is where most of the SCA's main business is discussed and decisions made, including how much money is available for disbursement to Legs in grants for the following Easter.
					</Text>

					<Subheading>Minutes of recent SCA meetings:</Subheading>

					<Link href='/sca-minutes-easter2021.pdf'>Easter 2021 AGM and committee meeting</Link>
					<Link href='/sca-minutes-oct2019.pdf'>October 2019 committee meeting</Link>

					<Text>All members of Pilgrim Cross, regardless of whether or not they are on the SCA Committee, can be invited to attend SCA meetings as an observer and/or to propose items for the agenda. However, as physical space can sometimes be limited, if you would like to attend an SCA meeting please contact the Chair in advance to let them know you would like to come.</Text>
